...
kings1 <- read.csv("data/Danish monarchs.csv")

kings2 <- read_csv("data/Danish monarchs.csv")

kings3 <- read.csv2("data/Danish monarchs.csv")

kings4 <- read_csv2( "data/Danish monarchs.csv")
```
Answer: 
...
kings <- read_csv("data/Danish monarchs.csv")
...
ggplot(kings, aes(x = mid_year, y = duration)) +
  ...
  geom_smooth() +
  labs(
    title = "Duration of Danish kings' reigns through time",
    x = "Mid-year of reign",
